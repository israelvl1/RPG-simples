...
class Personagem: # Definição da classe Personagem
    def __init__(self, nome, vida, sexo, classe,nivel=1, xp_atual=0):
        ...
        self.iluminado = False # Se o personagem está iluminado ou não
        ...
        self.max_vida = vida
        self.envenenado = False # Se o personagem está envenenado ou não
        self.queimado = False # Se o personagem está queimado ou não
        self.corrosivo = False # Se o personagem está corrosivo ou não
        self.visao_noturna = False # Se o personagem tem visão noturna ou não

...
def jogar():
    while True:
        ...
        escolha = int(
            input(
                f'"vamos começar nossa aventura!"'
                "! Entramos na caverna, logo tinha dois caminhos Qual será nosso caminho? 1°Com som de música | 2°Com uma risada sinistra!: "
            )
        )
        if escolha == 1:  # caso escolha 1
            print("Caimos num buraco")
            resposta = input(
                f'"Morremos de forma ridicula {heroi.nome} vamos tentar de novo? [S/N]: "'
            ).capitalize()
            ...
            print(
                f"O caminho parecia tranquilo até que, de repente, ouvimos novamente aquela risada macabra. Viramos rapidamente e, para nosso terror, vimos um goblin correndo em nossa direção, brandindo uma adaga afiada.. Logo {heroi.nome} puxar uma espada"
            )
            goblin = Personagem(
                "Goblin", 50, "Monstro"
            )  # objeto criado para ser o inimigo
            turno = 1
            while (
                heroi.esta_vivo() and goblin.esta_vivo()
            ):  # continua enquanto o heroi ou o goblin estiver vivo
                ...
                if goblin.esta_vivo():  # se o goblin estiver vivo, então ele atacar
                    ...
                    if tentar_desviar(
                        ...
                        if (
                            heroi.vida <= 0 and heroi.revive
                        ):  # se o heroi morrer e puder reviver
                            print("\n⚰️ O silêncio domina o campo de batalha...")
                            print(
                                f"{heroi.nome} cai de joelhos, sem forças, seus olhos se fechando lentamente."
                            )
                            print("...")
                            print("Mas então...")
                            print("🔥 Uma luz intensa irrompe do peito de seu corpo.")
                            print(
                                "As chamas douradas da lendária Poção da Fênix envolvem seu corpo em espirais flamejantes."
                            )
                            print(
                                "Um grito ecoa não da sua boca, mas da própria alma. O mundo para por um instante."
                            )
                            print(f"\n🕊️ {heroi.nome.upper()} RENASCEU!")

                            heroi.vida = (
                                heroi.max_vida
                            )  # voltar a vida a quantidade maxima
                            ...
                            print(
                                "Agora, seus inimigos não enfrentam mais um aventureiro..."
                            )
                            print(
                                "...eles enfrentam a ira de alguém que venceu a morte."
                            )
                            print(
                                "⚡ Os céus tremem. Os monstros recuam. O verdadeiro jogo começou.\n"
                            )
        ...
        if heroi.esta_vivo():  # caso o heroi ainda continua vivo
            ...
            if (
                vida_inicial == 1 and heroi.modo_vida == "f"
            ):  # se tiver escolhido o modo de vida f e tiver escolhido vida fixa inicial de 1
                escolha = input(
                    "Mestre: Sei que escolheu o modo infernal, mas não é ridículo morrer para um simples goblin? Esquecendo quer continuar? Talvez seja melhor diminuir a dificuldade [S/N]: "
                ).capitalize()
                if escolha == "s":  # se escolher continuar
                    ...
                    if heroi.sexo == "Feminino":  # se o sexo for Feminino
                        print(
                            '"Companheiro: Sério...Parece que você era uma fracote desde o início"'
                        )
                        break  # sai do loop
                    else:
                        print(
                            '"Companheiro: Sério...Parece que você era um fracote desde o início"'
                        )
                        break  # sai do loop
                else:
                    continue  # voltar ao início do loop
            elif (
                vida_inicial == 120 and heroi.modo_vida == "f"
            ):  # se tiver escolhido o modo de vida f e tiver escolhido vida fixa inicial de 120
                escolha = input(
                    "Mestre: Sei que escolheu o modo padrão, mas não é ridículo morrer para um simples goblin? Tipo você tinha capacidade de durar mais...Vamos tentar de novo! [S/N]: "
                ).capitalize()
                if escolha == "s":  # se escolher continuar
                    ...
                    if heroi.sexo == "Feminino":  # se o sexo for Feminino
                        print(
                            '"Companheiro: Parece que você era uma convarde desde o início"'
                        )
                        break  # sai do loop
                    else:
                        print(
                            '"Companheiro: Parece que você era um convarde desde o início"'
                        )
                        break  # sai do loop
                else:
                    continue  # voltar ao início do loop
            elif (
                vida_inicial == 150 and heroi.modo_vida == "f"
            ):  # se tiver escolhido o modo de vida f e tiver escolhido vida fixa inicial de 150
                escolha = input(
                    "Mestre: Sei que escolheu o modo equilibrado, mas não é era necessário ser equilibrado também no dano e na cura? Todo mundo falhar...Porém vamos continuar! [S/N]: "
                ).capitalize()
                if escolha == "s":  # se escolher continuar
                    print(
                        "Mestre: Legal... vamos tentar de novo. Só que, da próxima vez, seria bom se não precisássemos começar tudo do zero."
                    )
                    time.sleep(3)  # Espera 3 segundos
                    continue  # voltar ao início do loop
                elif escolha == "n":  # se quiser terminar o loop
                    if heroi.sexo == "Feminino":  # se o sexo for Feminino
                        print(
                            "Ele apenas virou o rosto para o lado, sem dizer uma palavra, deixando claro que não se importava com sua decisão. Apenas seguiu com o seu caminho, como se nada tivesse acontecido."
                        )
                        break  # sai do loop
                    else:
                        print(
                ...
                vida_inicial == 250 and heroi.modo_vida == "f"
            ):  # se tiver escolhido o modo de vida f e tiver escolhido vida fixa inicial de 250
                escolha = input(
                    "Mestre: Você escolheu o modo guerreiro, mas não! Tinha que ser morto por um goblin! Um goblin, sério? Vamos começar de novo logo, antes que eu perca mais tempo. [S/N]: "
                ).capitalize()
                if escolha == "s":  # se escolher continuar
                    ...
                    if heroi.sexo == "Feminino":
                        print(
                            '"Companheiro: Sua inútil, eu estava quase chegando no meu objetivo, era só você abrir o caminho e depois eu te mataria para ter meu tesouro, mas você falhou!"'
                        )
                        break  # sai do loop
                    else:  # recomeçar automaticamente se escollher opção errada
                        print(
                            '"Companheiro: Seu inútil, eu estava quase chegando no meu objetivo e era só você abrir o caminho e depois eu te mataria para ter meu tesouro, mas você falhou!"'
                        )
                        break  # sai do loop
                else:
                    continue
                ...
                if escolha == "s":  # se quiser recomeçar o jogo
                    ...
                    continue  # voltar ao início do loop
        print(
            f"Depois de {heroi.nome} matar o Goblin voltamos a andar em buscar do tesouro. Até que aparece um slime na nossa frente"
        )
        ...
        if heroi.esta_vivo():
            ...
            if vida_inicial == 80 and heroi.modo_vida == "f":
                escolha = input(
                    "Mestre: Sei que escolheu o modo infernal, mas não é ridículo morrer para um simples slime? Esquecendo quer continuar? Talvez seja melhor diminuir a dificuldade [S/N]: "
                ).capitalize()
                if escolha == "s":
                ...
                escolha = input(
                    "Mestre: Sei que escolheu o modo padrão, mas não é ridículo morrer para um simples slime? Tipo você tinha capacidade de durar mais...Vamos tentar de novo! [S/N]: "
                ).capitalize()
                if escolha == "s":
                ...
                escolha = input(
                    "Mestre: Você escolheu o modo guerreiro, mas não! Tinha que ser morto por um slime! Um slime, sério? Vamos começar de novo logo, antes que eu perca mais tempo. [S/N]: "
                ).capitalize()
                if escolha == "s":
                    if heroi.sexo == "Feminino":
                        print(
        ...
        print(
            "Estávamos andado até que dava para ouvir um grunhido estranho e logo aparecia um orc verde que estava sorrindo"
        )
        ...
        if heroi.esta_vivo():
            ...
            if vida_inicial == 80 and heroi.modo_vida == "f":
                escolha = input(
                    "Mestre: Sei que escolheu o modo infernal, mas você sabia que teria de matar um Orc? Esquecendo disso quer continuar? Talvez seja melhor diminuir a dificuldade [S/N]: "
                ).capitalize()
                if escolha == "s":
                ...
                escolha = input(
                    "Mestre: Sei que escolheu o modo padrão, mas não deveria ter tentando melhor contrar o Orc? Tipo você tinha capacidade de durar mais...Vamos tentar de novo! [S/N]: "
                ).capitalize()
                if escolha == "s":
                    print("Mestre: Um conselho tomar poção se necessário")
                    continue
                ...
                escolha = input(
                    " Mestre: Você escolheu o modo guerreiro, mas não! Tinha que ser morto por um Orc! Vamos começar de novo logo, antes que eu perca mais tempo. [S/N]: "
                ).capitalize()
                if escolha == "s":
                    if heroi.sexo == "Feminino":
                        print(
        ...
        print(
            "Enquanto andavamos surgir uma pessoa com um um cajado com uma bola de cristal roxa e quando apontava para nós percebiamos o que era"
        )
        print(f'"Cuidado {heroi.nome} ele é um necromante!"')
        necromante = Personagem(
            "Necromante", 110, "Monstro"
        )  # objeto criado para ser o Necromante
        turno = 1
        while heroi.esta_vivo() and necromante.esta_vivo():
            ...
            if necromante.esta_vivo():
                if chance(20):         # 20% de chance de se curar
                    ...
                    print('"Não lutarei contra você, mas meu soldado sim!"')
                        ...
                        if (
                            ...
                            if tentar_desviar(50):
                                ...
                                if heroi.vida <= 0 and heroi.revive:
                                    ...
                                    print("Mas então...")
                                    print(
                                        "🔥 Uma luz intensa irrompe do peito de seu corpo."
                                    )
                                    print(
                                        "As chamas douradas da lendária Poção da Fênix envolvem seu corpo em espirais flamejantes."
                                    )
                    ...
                    if heroi.esta_vivo():
                        ...
                        if vida_inicial == 80 and modo == "f":
                            escolha = input(
                                "Mestre: Sei que escolheu o modo infernal, mas não é ridículo morrer para um simples esqueleto? Esquecendo quer continuar? Talvez seja melhor diminuir a dificuldade [S/N]: "
                            ).capitalize()
                            if escolha == "s":
                            ...
                            escolha = input(
                                "Mestre: Sei que escolheu o modo padrão, mas não é ridículo morrer para um simples esqueleto? Tipo você tinha capacidade de durar mais...Vamos tentar de novo! [S/N]: "
                            ).capitalize()
                            if escolha == "s":
                            ...
                            escolha = input(
                                "Mestre: Você escolheu o modo guerreiro, mas não! Tinha que ser morto por um simples esqueleto! Vamos começar de novo logo, antes que eu perca mais tempo. [S/N]: "
                            ).capitalize()
                            if escolha == "s":
                                if heroi.sexo == "Feminino":
                                    print(
                    ...
                    if tentar_desviar(36):
                        ...
                        heroi.vida -= dano
                        print(
                            f"Necromante atacou {heroi.nome} e causou {dano} de dano!"
                        )
                        print(f"{heroi.nome} agora tem {heroi.vida} de vida.\n")
        ...
        if heroi.esta_vivo():
            ...
            if vida_inicial == 80 and heroi.modo_vida == "f":
                escolha = input(
                    "Mestre: Sei que escolheu o modo infernal, mas você sabia que teria de matar um Necromante né? Esquecendo disso quer continuar? Talvez seja melhor diminuir a dificuldade [S/N]: "
                ).capitalize()
                if escolha == "s":
                ...
                escolha = input(
                    "Mestre: Sei que escolheu o modo padrão, mas não deveria ter tentando melhor contrar o Necromante? Tipo você tinha capacidade de durar mais..., também ele era mais fraco de dano diferente do orc e ok vamos tentar de novo! [S/N]: "
                ).capitalize()
                if escolha == "s":
                    print("Mestre: Um conselho tomar poção se necessário")
                    continue
                ...
                escolha = input(
                    " Mestre: Você escolheu o modo guerreiro, mas não! Tinha que ser morto por um Necromante! Vamos começar de novo logo, antes que eu perca mais tempo. [S/N]: "
                ).capitalize()
                if escolha == "s":
                    if heroi.sexo == "Feminino":
                        print(
        ...
        print(
            "Continuamos nos aprofundando na caverna até que finalmente nos aproximávamos de um grande portão feito de ouro."
        )
        print(
        ...
        print(
            "Entravamos dentro da sala do tesouro, enquanto entrava dava para ver montes de dinheiro."
        )
        ...
        while dragao_dormindo <= 100:
            ...
            if escolha == 1:
                ...
                print(
                    "Meu companheiro parava na minha frente com os braços estendidos"
                    '"VOCÊ NÃO VAI FUGIR!"'
                )
                dragao_dormindo += 20
        ...
        if heroi.esta_vivo():
            ...
            if vida_inicial == 80 and heroi.modo_vida == "f":
                ...
                escolha = input(
                    "Mestre: Sei que escolheu o modo padrão, mas não deveria ter como você fica mais forte? Tipo você tinha capacidade de durar mais...Vamos tentar de novo! [S/N]: "
                ).capitalize()
                if escolha == "s":
                ...
                if escolha == "s":
                    ...
                    if heroi.sexo == "Feminino":
                        print(
                            "Companheiro: Ele apenas virou o rosto para o lado, sem dizer uma palavra, deixando claro que não se importava com sua decisão. Apenas seguiu com o seu caminho, como se nada tivesse acontecido."
                        )
                        break
                    else:
                        print(
                ...
                escolha = input(
                    " Mestre: Você escolheu o modo guerreiro, mas não! Tinha que ser morto por um Dragão! Vamos começar de novo logo, antes que eu perca mais tempo. [S/N]: "
                ).capitalize()
                if escolha == "s":
                    if heroi.sexo == "Feminino":
                        print(
        ...
        print(
            ...
            f"O companheiro te abraçava e no mesmo momento transparencia um sorriso maligna, então puxar uma espada estranha da sua bainha e te atravessar pela barriga"
        )
        ...
        if heroi.esta_vivo():  # SE o heroi estiver vivo
            print(
                f"{traidor.nome} estava ajoelhado no chão, o sangue escorrendo por entre os dedos."
            )
            print(
                f"Ele ergueu os olhos para {heroi.nome}, com um meio sorriso quebrado."
            )
            ...
            print(
                "🔥 ...e com um gesto firme, arrancou o Coração do Dragão, ainda pulsando com energia antiga."
            )
            ...
            print("...")
            print(
                "🕯️ Quando {heroi.nome} abriu os olhos novamente, já não estava mais na caverna."
            )
            print(
                "Estava de joelhos, sob o céu aberto... e nas palmas de suas mãos, o Coração virava cinzas."
            )
            print(
            ...
            if vida_inicial == 80 and heroi.modo_vida == "f":
                ...
                if escolha == "s":
                    ...
                    if heroi.sexo == "Feminino":
                        print(
                            '"Companheiro: Parece que você era uma convarde desde o início. Obrigado"'
                        )
                        break
                    else:
                        print(
                            '"Companheiro: Parece que você era um convarde desde o início. Obrigado"'
                        )
                        break
                else:
                    continue
                ...
                if escolha == "s":
                    ...
                    if heroi.sexo == "Feminino":
                        print(
                            "Ele apenas virou o rosto para o lado, sem dizer uma palavra, deixando claro que não se importava com sua decisão. Apenas seguiu com o seu caminho, como se nada tivesse acontecido. Pegando o coração do dragão e indo embora"
                        )
                        break
                else:
                    continue
                ...
                escolha = input(
                    "Mestre: Você escolheu o modo guerreiro, mas não! Tinha que ser morto por seu companheiro! Vamos começar de novo logo, antes que eu perca mais tempo. [S/N]: "
                ).capitalize()
                if escolha == "s":
                    if heroi.sexo == "Feminino":
                        print(
                    ...
                    print(
                        '"Companheiro: Você lutou com força, mas você foi quem morreu"'
                    )
                    break
                else:
                    continue
